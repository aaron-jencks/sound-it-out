...
#SBATCH --output=sst2-zs-%x-%j.out
#SBATCH --error=sst2-zs-%x-%j.err

# Parametrized via --export when calling sbatch:
#   sbatch --job-name=sst2-zs-en-text --export=ALL,LANG=en,REPR=text submit_zeroshot.sh
#
