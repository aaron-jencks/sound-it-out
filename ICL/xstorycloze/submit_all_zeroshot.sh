#!/bin/bash
# Submit zero-shot XStoryCloze eval jobs for all language × representation combinations.
#
# Supported languages: en, es, ru, hi  (ar, zh not in 8-lang training set)
# Supported representations: text, romanized, ipa
#
# Usage:
#   cd generative-classification-ipa-gpt-calibrate/xstorycloze
...
for lang in "${LANGS[@]}"; do
    for repr in "${REPRS[@]}"; do
        ...
        job_name="xsc-zs-${lang}-${repr}${SUFFIX}"
